...
-- | This module defines types and type families that allow you to define a typed JSON REST API
-- and then use this API type-safely in a number of ways:
--
-- - implement the api to produce an http server,
-- - retrieve typed getters to use your API client-side.
--
-- In the future we could implement:
--
-- - generation of documentation of the API.
--
-- For an example look at @examples/RestExample.hs@.

module Network.Wai.TypedRest (
  -- * Url Layout
  -- $url_layout
  Get,
  (:>)(..),
